            ...
            <li class="wiki-saved-item">
                ...
                <div class="wiki-meta">
                    ...
                    <?php if ( ! empty( $saved['last_saved_at_display'] ) ) : ?>
                        <span><?php echo esc_html( __( 'Last saved', 'wordopedia' ) . ' ' . $saved['last_saved_at_display'] ); ?></span>
                    <?php endif; ?>
                </div>
                ...
                <div class="wiki-article-tools">
                    <a class="wiki-btn secondary" href="<?php echo esc_url( $saved['view_url'] ); ?>"><?php esc_html_e( 'Read saved', 'wordopedia' ); ?></a>
                    <a class="wiki-btn secondary" href="<?php echo esc_url( $saved['live_app_url'] ); ?>"><?php esc_html_e( 'Open live', 'wordopedia' ); ?></a>
                    <?php if ( current_user_can( 'edit_posts' ) ) : ?>
                        <form class="wiki-inline-form" method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
                            ...
                            <button class="wiki-btn secondary" type="submit"><?php esc_html_e( 'Refetch', 'wordopedia' ); ?></button>
                        </form>
                    <?php endif; ?>
                </div>
            </li>
...
<?php else : ?>
    <div class="wiki-notice"><?php esc_html_e( 'No saved articles found.', 'wordopedia' ); ?></div>
<?php endif; ?>
