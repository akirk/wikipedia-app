...
class App extends BaseApp {
    ...
    protected function setup_storage(): void {
         ...
         *
         * class Akirk\WikipediaStorage extends BaseStorage {
         *     protected function get_schema() {
         *         $charset_collate = $this->wpdb->get_charset_collate();
         *         return [
         *             "CREATE TABLE {$this->wpdb->prefix}wikipedia_items (
         ...
         * }
         *
         * Then in __construct(): $this->storage = new Akirk\WikipediaStorage();
    ...
    protected function setup_menu(): void {
         ...
         *
         * $this->app->add_menu_item( 'overview', 'Overview', home_url( '/wikipedia-app/overview' ) );
         */
    }
    ...
    public function register_post_types(): void {
         ...
         *
         * register_post_type( 'wikipedia_item', [
    ...
    public function register_taxonomies(): void {
         ...
         *
         * register_taxonomy( 'wikipedia_category', 'wikipedia_item', [
    ...
    public function render_dashboard_widget(): void {
        /*
         * echo esc_html__( 'Add your dashboard summary here.', 'wikipedia' );
         */
    }
    ...
    public function register_ability_category(): void {
        ...
        //     'description' => __( 'Abilities for Wikipedia.', 'wikipedia' ),
        // ] );
    }
    ...
    public function register_abilities(): void {
        ...
        // }
        //
        // wp_register_ability( 'wikipedia/list-items', [
        //     'label'               => __( 'List Wikipedia Items', 'wikipedia' ),
        //     'description'         => 'Returns Wikipedia items with IDs and titles for follow-up ability calls.',
        //     'category'            => 'wikipedia',
        //     'input_schema'        => [
        //         'type'                 => 'object',
        //         'properties'           => [
        ...
        //                     'type'       => 'object',
        //                     'properties' => [
        //                         'id'    => [ 'type' => 'integer', 'description' => 'Use with wikipedia/get-item.' ],
        //                         'title' => [ 'type' => 'string' ],
        //                     ],
        //                 ],
        //             ],
    ...
    public function list_ability_items( $input ): array {
        ...
        //         [
        //             'id'    => 123,
        //             'title' => __( 'Example item', 'wikipedia' ),
        //         ],
        //     ],
        // ];
        return [
    ...
    public function register_ai_assistant_ability_domains( array $domains ): array {
        ...
        //
        // $domains['wikipedia'] = 'Wikipedia, items, records, dashboard';
        return $domains;
    }
    ...
    public function get_ai_assistant_ability_instructions( string $instructions, string $ability_id, $args, $result ): string {
        ...
        //
        // if ( 'wikipedia/list-items' === $ability_id && ! empty( $result['items'] ) ) {
